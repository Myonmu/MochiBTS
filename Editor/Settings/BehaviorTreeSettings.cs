...
namespace MochiBTS.Editor
{
    internal class BehaviorTreeSettings : ScriptableObject
    {
        ...
        public List<Texture2D> nodeIcons = new List<Texture2D>();
        ...
        internal static BehaviorTreeSettings GetOrCreateSettings()
        {
            ...
            AssetDatabase.CreateAsset(settings, "Assets/Plugins/MochiBTS/BehaviourTreeSettings.asset");
        ...
        internal Texture2D GetIcon(Node node)
        {
